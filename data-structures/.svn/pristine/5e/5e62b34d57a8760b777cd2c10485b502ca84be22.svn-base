...
public class RemoveTests {
    ...
    @Test(dataProvider = "getClassStrategy")
    public void removeShouldFindAndRemoveNullKeyCorrectly(Map<Character, Integer> map) {
	for (int i = ONE; i < this.size; i++) {
	    map.put((char) i, i);
	}
	final int num = NumberGenerator.generate(2000);
	map.put(null, num);
    ...
    @Test(dataProvider = "getClassStrategy")
    public void removeShouldFindAndRemoveLastElement(Map<String, Integer> map) {
    ...
    @Test(dataProvider = "getClassStrategy")
    public void removeShouldFindAndRemoveLastElementInCollision(Map<Character, Integer> map) {
